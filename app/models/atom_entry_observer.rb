...
class AtomEntryObserver < ActiveRecord::Observer
  include Miletus::NamespaceHelper

  observe Miletus::Harvest::Atom::RDC::Entry
  ...
  class AbstractJob < Struct.new(:entry)
  ...
  class CreateFacetJob < AbstractJob
    def run
      split_rifcs_document(entry.to_rif).each do |xml|
